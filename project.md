...
When I interviewed users about these ads, an interesting trend emerged: most didn't pay attention to them. One interviewee even said, '就是我真的一点都不在意这个东西，我只看得见3.2.1 跳过'[5s] (i really never cared about the content, the only thing in my eyes is 3,2,1 skip'). This highlights a kind of passive resistance to these intrusive algorithms, where users simply bypass the ads whenever possible to avoid seeing them.

### 01:51 - 02:40 — Excerpt 1: User Reaction [112 words]
But not everyone totally ignores these ads. One interviewee described herself as 'rebellious' in her reaction to those banners. '我觉得我可能有点逆反，比如说，我需要一双靴子，当我发现淘宝在监听我或者是它的算法计算到我有想要买靴子的动机，它给我推送到开屏广告上的商品我是一定不会关注的，我觉得它在试图引导我，让我很烦'[17s] (I think I‘m a bit rebellious. For example, if I need a pair of boots, when I find out that Taobao is monitoring me or its algorithm calculates that I want boots, I will definitely not pay attention to the products it pushes to me on the fullscreen banners. I think it is trying to guide me, which annoys me a lot.).
...
To dig deeper, I asked this interviewee if her feelings would change if Taobao made the algorithm behind these ads more transparent. After some hesitation, she responded: She thinks for the ads, the behind must be more than algorithm,'我觉得它推给我还是因为有分红，或者这个靴子商品在宣传上下的成本比其他商品要大，既然如此我是不愿意为它这部分成本买单的'[12s] (I think it was pushed to me still because of trading between product and platforms, or this boot A pays more in advertising. In this case, I am unwilling to pay for this part of the cost.).
